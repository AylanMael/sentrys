              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-4">
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl xl:text-6xl/none font-headline text-primary">
                    Opérations de Sécurité Modernes, Simplifiées
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    SENTRYS fournit une plateforme tout-en-un pour les entreprises de sécurité privée pour gérer les agents, planifier les missions et signaler les incidents avec efficacité et précision.
                  </p>
                </div>
