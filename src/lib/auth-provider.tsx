      ...
      if (firebaseUser) {
        ...
        try {
            ...
            if (tenantUserSnap.exists()) {
                ...
                // If a user is authenticated in Firebase Auth but has no corresponding
                // document in Firestore, it's an invalid state.
                // We sign them out to prevent a redirect loop.
                // The login page will handle showing a specific error message.
                await auth.signOut();
                setUser(null);
            }
        } catch (error) {
